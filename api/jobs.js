...
const CATS = {
  'sw-out':   {label:'Support Worker Outside London',  group:'sw',    exLoc:'london', exc:SW_EXC},
  'sw-lon':   {label:'Support Worker in London',       group:'sw',    loc:'london',   exc:SW_EXC},
  'sw-wm':    {label:'Support Worker West Midlands',   group:'sw',    loc:'west midlands', exc:SW_EXC},
  'sw-wales': {label:'Support Worker in Wales',        group:'sw',    loc:'wales',    exc:SW_EXC},
  'sw-manc':  {label:'Support Worker Manchester',      group:'sw',    loc:'manchester', exc:SW_EXC},
  'sw-wy':    {label:'Support Worker W Yorkshire',     group:'sw',    loc:'leeds',    exc:SW_EXC},
  'sw-ey':    {label:'Support Worker E Yorkshire',     group:'sw',    loc:'hull',     exc:SW_EXC},
  'admin-out':{label:'Admin Outside London',           group:'admin', exLoc:'london', exc:ADMIN_EXC},
  'admin-lon':{label:'Admin in London',                group:'admin', loc:'london',   exc:ADMIN_EXC},
  'nurse':    {label:'Staff Nurse',                    group:'nurse', minBand:5, maxBand:5, exc:NURSE_EXC},
  'mh-nurse': {label:'Mental Health Nurse',            group:'mhnurse', exc:MH_EXC},
  'res-nurse':{label:'Research Nurse',                 group:'resnurse'},
  'fellow':   {label:'Clinical Fellow',                group:'fellow', exc:FEL_EXC},
  'coder':    {label:'Clinical Coder',                 group:'coder'},
  'diet':     {label:'Dietician',                      group:'diet'},
  'micro':    {label:'Microbiology',                   group:'micro'},
  'phleb':    {label:'Phlebotomist Leader',            group:'phleb'},
  'res-asst': {label:'Research Assistant',             group:'res',    exc:RES_EXC},
  'sw3':      {label:'Social Worker',                  group:'sw3',    exc:SW2_EXC},
  'data':     {label:'Data Analyst',                   group:'data',   exc:DATA_EXC},
  'bi':       {label:'BI Analyst',                     group:'bi'},
  'fin':      {label:'Finance',                        group:'fin',    exc:FIN_EXC},
  'hr':       {label:'HR',                             group:'hr',     exc:HR_EXC},
  'it':       {label:'IT / Engineering',               group:'it',     exc:IT_EXC},
  'pm':       {label:'Project Manager',                group:'pm',     exc:PM_EXC},
  'ba':       {label:'Business Analyst',               group:'ba',     exc:BA_EXC},
  'log':      {label:'Logistics',                      group:'log'},
  'coord':    {label:'Coordinator',                    group:'coord'},
  'est':      {label:'Estates',                        group:'est'},
};
