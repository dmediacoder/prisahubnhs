...
const SEARCHES = [
  ...
  // Clinical - no band filter for clinical roles
  {kw:'clinical fellow',        bands:'', ft:false},
  {kw:'trust doctor',           bands:'', ft:false},
  {kw:'foundation doctor',      bands:'', ft:false},
  {kw:'clinical coder',         bands:'', ft:false},
  {kw:'dietitian',              bands:'', ft:false},
  {kw:'phlebotomist',           bands:'', ft:false},
  {kw:'research assistant',     bands:'', ft:false},
  {kw:'clinical research',      bands:'', ft:false},
  {kw:'social worker',          bands:'', ft:false},
  {kw:'microbiologist',         bands:'', ft:false},
  {kw:'research nurse',         bands:'', ft:false},
  // Professional - Band 5,6,7
  {kw:'data analyst',           bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'business intelligence',  bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'finance manager',        bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'finance officer',        bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'hr adviser',             bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'hr officer',             bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'it engineer',            bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'software engineer',      bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'network engineer',       bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'project manager',        bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'programme manager',      bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'business analyst',       bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'procurement officer',    bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'pathway coordinator',    bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'care coordinator',       bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'estates officer',        bands:'BAND_5,BAND_6,BAND_7', ft:false},
  {kw:'facilities manager',     bands:'BAND_5,BAND_6,BAND_7', ft:false},
];
